...
std::vector<MeshTriangle> MeshCutter::CreateCubeMesh(float size, ::Color color)
{
...
std::vector<MeshTriangle> MeshCutter::CreateSphereMesh(float radius, int rings, int slices, ::Color color)
{
    std::vector<MeshTriangle> triangles;
...
CuttableMesh* CuttableMeshManager::CreateCube(Vector3 position, float size, ::Color color)
{
    ...
    mesh->triangles = MeshCutter::CreateCubeMesh(size, color);
    mesh->color = color;
...
{
    CuttableMesh* mesh = new CuttableMesh();
    mesh->triangles = MeshCutter::CreateSphereMesh(radius, rings, slices, color);
    mesh->color = color;
    mesh->markedForDestruction = false;
    mesh->centerOfMass = MeshCutter::CalculateCenterOfMass(mesh->triangles);
